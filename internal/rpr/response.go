...
func NewResponse[T any](payload T, err error) *Response {
	return &Response{
		Payload: WrapPayload(PreparePayload(payload)),
		Err:     err,
	}
}
...
func NewResponse2[T1 any, T2 any](payload1 T1, payload2 T2, err error) *Response {
	return &Response{
		Payload: WrapPayload(PreparePayload2(payload1, payload2)),
		Err:     err,
	}
}
...
func NewResponse3[T1 any, T2 any, T3 any](payload1 T1, payload2 T2, payload3 T3, err error) *Response {
	return &Response{
		Payload: WrapPayload(PreparePayload3(payload1, payload2, payload3)),
		Err:     err,
	}
}
